...
{
    public const string ContainerSuffixKey = "SimplyBudgetWeb:ContainerSuffix";
    public const string Frontend = "SimplyBudgetWeb-frontend";
    public const string SqlServer = "SimplyBudgetWeb-sql";
    ...
    extension(IDistributedApplicationBuilder builder)
    {
        ...
        {
            return builder.AddAzureSqlServer("SimplyBudgetWeb-sql");
        }
        ...
        public IResourceBuilder<SqlServerServerResource> AddSqlServer()
        {
            ...
            string? containerName = string.IsNullOrWhiteSpace(containerSuffix) ? "SimplyBudgetWeb-sql" : $"SimplyBudgetWeb-{containerSuffix}-sql";
            
            return builder
                .AddSqlServer(SqlServer)
                .WithLifetime(ContainerLifetime.Persistent)
                .WithContainerName(containerName)
                .WithDataVolume("SimplyBudgetWeb-database")
...
#pragma warning restore ASPIREINTERACTION001 // Type is for evaluation purposes only and is subject to change or removal in future updates. Suppress this diagnostic to proceed.
                ProcessStartInfo psi = new()
                {
                    ...
                    ArgumentList = {
                        ...
                        "--no-build",
                        "--project",
                        "SimplyBudgetWeb.UITests\\SimplyBudgetWeb.UITests.csproj"
                    },
    ...
    extension(IResourceBuilder<SqlServerServerResource> sql)
    {
        ...
        {
            var database = sql.AddDatabase("SimplyBudgetWeb-db");
...
#pragma warning restore ASPIREINTERACTION001 // Type is for evaluation purposes only and is subject to change or removal in future updates. Suppress this diagnostic to proceed.
                ProcessStartInfo psi = new()
                {
                    ...
                    ArgumentList = {
                        ...
                        "migrations",
                        "--startup-project",
                        "./SimplyBudgetWeb.AppHost",
                        "--project",
                        "./SimplyBudgetWeb.Data",
                        "--no-build",
                        "add",
