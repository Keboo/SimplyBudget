...
// For a service named "SimplyBudgetWeb-backend", it would be services__SimplyBudgetWeb-backend__https__0 or services__SimplyBudgetWeb-backend__http__0
...
const backendUrl = process.env.BACKEND_URL
  || process.env['services__SimplyBudgetWeb-backend__http__0'] 
  || process.env['services__SimplyBudgetWeb-backend__https__0'] 
